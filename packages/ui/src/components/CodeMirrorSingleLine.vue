...
const text = view.state.doc.toString()
    ...
    view.dispatch({
        changes: { from, to, insert: completionText }
                                ...
                                const newText = view.state.doc.sliceString(0).replaceAll('{{{', '{{').replaceAll('{ {{', '{{ ').replaceAll('{{{{', '{{').replaceAll('{{ {{', '{{ ').replaceAll('{{{ ', '{{').replaceAll('{{  ', '{{ ').replaceAll('  }}', ' }}').replaceAll('   }}}}', ' }}').replaceAll('{{ {', '{{ ').replaceAll(' }} }}', '}}')
                                view.dispatch({
